...
import com.gruber.pfr.space.base.map.MapConcatenation;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		IntegerToRationalInjection int2rat = new IntegerToRationalInjection();
		RationalToRealInjection rat2real = new RationalToRealInjection();

		try {
			Map int2real = MapConcatenation.concatenateMaps(int2rat, rat2real);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
// -> due to number overflow, addition and multiplication are not correct
			...
			System.out.println(cl1.getIntBase()+" "+cl2.getIntBase()+" "+clplus.getIntBase()+" "+cltimes.getIntBase());
		}
	}
}
