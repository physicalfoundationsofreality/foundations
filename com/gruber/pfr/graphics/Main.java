...
public class Main {
	...
	public static Visualization2D vectorTest2() {
		...
		try {
			...
			return new RealBasedCurves2D(ret);
...
//			vel[0] = new RealVector(new RealNumber[] { new RealNumber(1) });
			...
			RealBasedVector start = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(10) }));
			RealBasedVector vel = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(1) }));
...
//			vel[0] = new RealVector(new RealNumber[] { new RealNumber(-4), new RealNumber(3) });
//
//			start[1] = new RealVector(new RealNumber[] { new RealNumber(9), new RealNumber(0) });
//			vel[1] = new RealVector(new RealNumber[] { new RealNumber(-4), new RealNumber(-3) });
//
//			start[2] = new RealVector(new RealNumber[] { new RealNumber(8), new RealNumber(0) });
//			vel[2] = new RealVector(new RealNumber[] { new RealNumber(-10), new RealNumber(-2) });
			...
			start = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(9),new RealNumber(0) }));
			vel = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(-4),new RealNumber(-3) }));
			
			configs.add(new PhaseSpaceStartConfiguration(Color.GREEN,Color.BLACK,start,vel));
			
			start = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(8),new RealNumber(0) }));
			vel = new RealBasedVector(
					new RealVector(new RealNumber[] { new RealNumber(-10),new RealNumber(-2) }));
			...
			RealBasedVisualization curves = new RealBasedCurvesProjection(new PhaseSpaceCurvesApproximation(configs, 2, 100, 2,
					new CentralForceField(2, 500, new Double(-2).floatValue())),projMap);
...
//			RealNumber[] origin = { new RealNumber(5), new RealNumber(0), new RealNumber(1) };
//			RealNumber[] velocity = { new RealNumber(0), new RealNumber(0), new RealNumber(0) };
//			config[0] = new PhaseSpaceParticleConfiguration(Color.BLUE, Color.BLACK, origin, velocity, 500, 100);
//			
//			origin = new RealNumber[]{ new RealNumber(0), new RealNumber(5), new RealNumber(10) };
//			velocity = new RealNumber[]{ new RealNumber(-5), new RealNumber(0), new RealNumber(1) };
//			config[1] = new PhaseSpaceParticleConfiguration(Color.CYAN, Color.BLACK, origin, velocity, 100, 100);
			
			// Ein schwerer, ein leichter Körper
//			RealNumber[] origin = { new RealNumber(0), new RealNumber(0), new RealNumber(0) };
//			RealNumber[] velocity = { new RealNumber(0), new RealNumber(0), new RealNumber(0) };
//			config[0] = new PhaseSpaceParticleConfiguration(Color.BLUE, Color.BLACK, origin, velocity, 1000, 1000);
//			
//			origin = new RealNumber[]{ new RealNumber(10), new RealNumber(0), new RealNumber(10) };
//			velocity = new RealNumber[]{ new RealNumber(0), new RealNumber(10), new RealNumber(0) };
//			config[1] = new PhaseSpaceParticleConfiguration(Color.CYAN, Color.BLACK, origin, velocity, new Double(10).floatValue(), 10);

			// 3 Körper: Ein schwerer, zwei leichte Körper Mache zuerst beide unabhängig voneinander
			RealNumber[] origin = { new RealNumber(0), new RealNumber(0), new RealNumber(0) };
			RealNumber[] velocity = { new RealNumber(0), new RealNumber(0), new RealNumber(0) };
			config[0] = new PhaseSpaceParticleConfiguration(Color.BLUE, Color.BLACK, origin, velocity, 100000, 10000000);
...
//			
			...
			velocity = new RealNumber[]{ new RealNumber(0), new RealNumber(new Double(40).floatValue()), new RealNumber(0) };
			config[2] = new PhaseSpaceParticleConfiguration(Color.red, Color.BLACK, origin, velocity, new Double(10).floatValue(), 10);
...
// Projection from 3-Phase Space to x-y coordinates
			RealNumber[][] proj1 = { { new RealNumber(1), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0) },
					{ new RealNumber(0), new RealNumber(1), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0), } };

			// projection onto x y velocity coordinates
			RealNumber[][] proj2 = { { new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(1), new RealNumber(0), new RealNumber(0) },
					{ new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(1), new RealNumber(0) } };

			// projection onto X space/velocity coordinates
			RealNumber[][] proj3 = { { new RealNumber(1), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(0) },
					{ new RealNumber(0), new RealNumber(0), new RealNumber(0), new RealNumber(1), new RealNumber(0), new RealNumber(0), } };
